 ...
 * @requires jQuery
 * -- DO NOT REMOVE -- */
if ("undefined" == typeof jQuery) throw new Error("MDTimePicker: This plugin requires jQuery");
+function (e) {
  var t = "mdtimepicker",
    i = 120,
    s = 90,
    ...
    d = function d(t, i) {
      ...
      if (s.setup(n).appendTo("body"), n.clockHolder.am.click(function () {
        ...
        s.input.trigger(e.Event("timechanged", {
          time: t.time,
          value: t.value
        })).trigger("onchange").trigger("change"), s.hide();
  ...
  d.prototype = {
    ...
    setup: function setup(t) {
      ...
      for (var l = 0; 60 > l; l++) {
        ...
        l % 5 === 0 ? k.addClass("marker").html("<span>" + v + "</span>") : k.html("<span></span>"), k.find("span").click(function () {
    ...
    parseTime: function parseTime(e, t) {
      var i = this,
        ...
        l = "",
        p = "";
      if (i.config.hourPadding || r) m = e.substr(d, 2);else {
    ...
    return e(this).each(function () {
      var s = this,
        n = e(this),
        r = e(this).data(t);
      options = e.extend({}, e.fn.mdtimepicker.defaults, n.data(), "object" == _typeof(i) && i), r || n.data(t, r = new d(s, options)), "string" == typeof i && r[i](), e(document).on("keydown", function (e) {
